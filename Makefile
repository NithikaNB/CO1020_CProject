...
run-demo: $(DEMO_TARGET)
	...
	./$(DEMO_TARGET)
	@if exist $(FRAMEDIR)\frame_*.pgm (ffmpeg -framerate 60 -i $(FRAMEDIR)/frame_%%03d.pgm -c:v libx264 -pix_fmt yuv420p -crf 18 -preset slow $(DEMO_MP4_OUTPUT)) else (echo No frames generated by demo)
